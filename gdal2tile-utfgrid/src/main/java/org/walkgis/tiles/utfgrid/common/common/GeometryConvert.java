package org.walkgis.tiles.utfgrid.common.common;
...
public class GeometryConvert {
    ...
    private MultiPolygon multiPolygonSerializable(org.locationtech.jts.geom.MultiPolygon multiPolygon) {
        ...
        for (int i = 0; i < count; ++i) {
            org.locationtech.jts.geom.Geometry geometry = multiPolygon.getGeometryN(i);
    ...
    private GeometryCollection geometryCollectionSerializable(org.locationtech.jts.geom.GeometryCollection geometryCollection) {
        ...
        for (int i = 0; i < geometryCollection.getNumGeometries(); ++i) {
            org.locationtech.jts.geom.Geometry geometry = geometryCollection.getGeometryN(i);
    ...
    public GeoJsonObject geometrySerializer(org.locationtech.jts.geom.Geometry geometry) throws Exception {
    ...
    private org.locationtech.jts.geom.MultiPoint multiPointDeserialize(MultiPoint multiPoint) {
        org.locationtech.jts.geom.Point[] points = multiPoint.getCoordinates().stream().map((item) -> {
    ...
    public org.locationtech.jts.geom.GeometryCollection geometryCollectionDeserialize(GeometryCollection geoJsonObjects) {
        ...
        org.locationtech.jts.geom.Geometry[] geometries1 = geometries.stream().toArray((x$0) -> new org.locationtech.jts.geom.Geometry[x$0]);
        return new org.locationtech.jts.geom.GeometryCollection(geometries1, this.geometryFactory);
    }

    public org.locationtech.jts.geom.Geometry geometryDeserialize(GeoJsonObject geometry) throws Exception {
