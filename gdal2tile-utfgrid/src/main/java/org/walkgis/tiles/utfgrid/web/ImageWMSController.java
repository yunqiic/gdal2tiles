...
import org.walkgis.tiles.utfgrid.common.common.GlobalGeodetic;
import org.walkgis.tiles.utfgrid.common.common.GlobalMercator;
import org.walkgis.tiles.utfgrid.common.entity.GeoEntity;
import org.walkgis.tiles.utfgrid.common.service.GeoJsonServicesImpl;
import org.walkgis.tiles.utfgrid.entity.LocationsWithShape;
...
public class ImageWMSController extends GeoJsonServicesImpl<LocationsWithShape, Integer> {
    ...
    public void imageWMS(
        ...
        List<GeoEntity> countyAreas = sqlManager.execute(new SQLReady(sql), GeoEntity.class);
        rTree = RTree.create();
        countyAreas.forEach(baseEntity -> {
            try {
                ...
                rTree = rTree.add((Integer) baseEntity.getId(), Geometries.rectangleGeographic(envelope1.getMinX(), envelope1.getMinY(), envelope1.getMaxX(), envelope1.getMaxY()));
...
//        }
    ...
    public void generateVectorTiles(
        ...
        if (!file.exists()) {
            ...
            List<GeoEntity> tRiverList = sqlManager.execute(new SQLReady(sql), GeoEntity.class);
...
//        }
    ...
    private List<LocationsWithShape> buildShape() throws SQLException {
        ...
        resFeas.add(new LocationsWithShape(1, pGobject));
        ...
        resFeas.add(new LocationsWithShape(2, pGobject));
        ...
        resFeas.add(new LocationsWithShape(3, pGobject));
        return resFeas;
    }
    ...
    private static List<LocationsWithShape> buildData() {
        ...
        LocationsWithShape locationsWithShape = new LocationsWithShape(4, pGobject);
        ...
        locationsWithShape = new LocationsWithShape(5, pGobject);
        list.add(locationsWithShape);
        return list;
    }
