...
public class TileDetail {
    ...
    public TileDetail(Long index, Integer tx, Integer ty, Integer tz, Integer rx, Integer ry, Integer rxsize, Integer rysize, Integer wx, Integer wy, Integer wxsize, Integer wysize, Integer querysize) {
        this.index = index;
        this.tx = tx;
        this.ty = ty;
        this.tz = tz;
